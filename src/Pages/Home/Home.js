...
import { Animator, ScrollContainer, ScrollPage, batch, Sticky, Fade, FadeIn, MoveIn, MoveOut, Absolute, StickyIn, ZoomIn } from "react-scroll-motion";

export default function Home() {
  useEffect(() => {
    var aDiv = document.getElementById("history");
    var bDiv = document.getElementById("headless");
    function changeWidth() {
      ...
      // bDiv.style.width.backgroundColor = "#EDF5F8"
    }
    ...
    <div>
      <div className='home'>
        ...
        <div className='content'>
          <div className='contenthead centre'>
          ...
          <div className='imgs'>
            <ScrollContainer>
              <ScrollPage className='scrollpage'>
                <Animator animation={MoveOut(100, 600)}>
            ...
            <ScrollContainer>
              <ScrollPage className='scrollpage'>
                <Animator animation={MoveOut(-100, 200)}>
            ...
            <ScrollContainer>
              <ScrollPage className='scrollpage'>
                <Animator animation={MoveOut(-600, 700)}>
      ...
      <div className='headless' id='headless'>
        <div className='images'>
          ...
          <div className='himg1'>
            <img src={himg1} alt='img2' />STRIPE
          </div>

          <div className='himg2'>
            <img className='himg2' src={himg2} alt='img3' />KLAVIYO
          </div>

          <div className='himg3'>
            <img className='himg3' src={himg3} alt='img4' />SOCIAL
          </div>
      ...
      <div className='map'>
              ...
              <div className='card'>
                ...
                <div className='cardbody'>
                  <p style={{ color: "lightgray" }}>
                    Select warehouses from which you will ship products for this shipping zone. This warehouses addresses will also be used to calculate taxes
                  </p>
                  ...
                  <div className='warehouses'>
                    <button>Minneapolis</button>
                    <button>Frankfurt</button>
                  </div>
                </div>
              </div>
            </Animator>
        ...
        <div className='mapText'>
          <h1>Global by design</h1>
          <h2><b>Made to power fast-growing e-commerce brands worldwide.</b></h2>
        </div>
      </div>
